defmodule ElixirTemplateWeb.Components.Breadcrumb do
  @moduledoc """
  Provides a flexible and customizable `ElixirTemplateWeb.Components.Breadcrumb` component for displaying
