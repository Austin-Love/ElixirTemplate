defmodule ElixirTemplateWeb.Components.Overlay do
  @moduledoc """
  The `ElixirTemplateWeb.Components.Overlay` module provides a versatile overlay component for
  ...
  The `ElixirTemplateWeb.Components.Overlay` is perfect for creating modal backgrounds, loading screens,
