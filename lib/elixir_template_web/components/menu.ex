defmodule ElixirTemplateWeb.Components.Menu do
  @moduledoc """
  The `ElixirTemplateWeb.Components.Menu` module is designed to render a hierarchical menu structure in
  ...
  import ElixirTemplateWeb.Components.Accordion, only: [accordion: 1]
  import ElixirTemplateWeb.Components.Button, only: [button_link: 1]
