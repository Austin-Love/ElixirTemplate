defmodule ElixirTemplateWeb.Components.Stepper do
  @moduledoc """
  The `ElixirTemplateWeb.Components.Stepper` module provides a flexible and interactive stepper component
  ...
  The `ElixirTemplateWeb.Components.Stepper` enhances user experience by providing a clear and concise representation
