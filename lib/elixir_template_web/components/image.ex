defmodule ElixirTemplateWeb.Components.Image do
  @moduledoc """
  The `ElixirTemplateWeb.Components.Image` module provides a component for rendering images in a Phoenix application.
