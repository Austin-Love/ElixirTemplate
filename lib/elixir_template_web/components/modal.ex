defmodule ElixirTemplateWeb.Components.Modal do
  @moduledoc """
  The `ElixirTemplateWeb.Components.Modal` module provides a versatile and customizable modal component for
