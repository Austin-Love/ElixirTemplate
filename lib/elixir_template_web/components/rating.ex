defmodule ElixirTemplateWeb.Components.Rating do
  @moduledoc """
  The `ElixirTemplateWeb.Components.Rating` module provides a versatile rating component for Phoenix LiveView
