defmodule ElixirTemplateWeb.Components.Popover do
  @moduledoc """
  The `ElixirTemplateWeb.Components.Popover` module provides a versatile popover component for Phoenix LiveView
