defmodule ElixirTemplateWeb.Components.Carousel do
  @moduledoc """
  Provides a versatile and customizable carousel component for the `ElixirTemplateWeb.Components.Carousel`
  project.
