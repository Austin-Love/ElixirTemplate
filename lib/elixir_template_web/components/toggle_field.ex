defmodule ElixirTemplateWeb.Components.ToggleField do
  @moduledoc """
  ElixirTemplateWeb.Components.ToggleField component renders a toggle field with customizable options.
