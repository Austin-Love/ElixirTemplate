defmodule ElixirTemplateWeb.Components.NativeSelect do
  @moduledoc """
  The `ElixirTemplateWeb.Components.NativeSelect` module provides a customizable native select component
