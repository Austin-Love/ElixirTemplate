defmodule ElixirTemplateWeb.Components.UrlField do
  @moduledoc """
  ElixirTemplateWeb.Components.UrlField, A component for rendering a URL input field in a Phoenix application.
