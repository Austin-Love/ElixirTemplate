defmodule ElixirTemplateWeb.Components.Jumbotron do
  @moduledoc """
  The `ElixirTemplateWeb.Components.Jumbotron` module provides a versatile component for creating large,
