defmodule ElixirTemplateWeb.Components.Banner do
  @moduledoc """
  ElixirTemplateWeb.Components.Banner module provides components for rendering customizable banners in your **Phoenix LiveView**
  application.
