defmodule ElixirTemplateWeb.Components.FileField do
  @moduledoc """
  The `ElixirTemplateWeb.Components.FileField` module provides a versatile and customizable component
  ...
  import ElixirTemplateWeb.Components.Progress, only: [progress: 1]
