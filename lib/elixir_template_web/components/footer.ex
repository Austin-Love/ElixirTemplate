defmodule ElixirTemplateWeb.Components.Footer do
  @moduledoc """
  The `ElixirTemplateWeb.Components.Footer` module provides a customizable footer component for Phoenix applications,
