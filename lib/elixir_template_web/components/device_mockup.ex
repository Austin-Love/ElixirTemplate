defmodule ElixirTemplateWeb.Components.DeviceMockup do
  @moduledoc """
  The `ElixirTemplateWeb.Components.DeviceMockup` module provides a customizable component for displaying
