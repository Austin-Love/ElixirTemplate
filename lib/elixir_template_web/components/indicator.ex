defmodule ElixirTemplateWeb.Components.Indicator do
  @moduledoc """
  The `ElixirTemplateWeb.Components.Indicator` module provides a versatile component for visually highlighting
