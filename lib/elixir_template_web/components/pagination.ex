defmodule ElixirTemplateWeb.Components.Pagination do
  @moduledoc """
  The `ElixirTemplateWeb.Components.Pagination` module provides a comprehensive and highly customizable
