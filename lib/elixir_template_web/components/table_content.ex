defmodule ElixirTemplateWeb.Components.TableContent do
  @moduledoc """
  `ElixirTemplateWeb.Components.TableContent` is a component module designed to create flexible and dynamic
