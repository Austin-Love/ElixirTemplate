defmodule ElixirTemplateWeb.Components.Gallery do
  @moduledoc """
  The `ElixirTemplateWeb.Components.Gallery` module provides a customizable gallery component for displaying
