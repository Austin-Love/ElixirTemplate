defmodule ElixirTemplateWeb.Components.MegaMenu do
  @moduledoc """
  The `ElixirTemplateWeb.Components.MegaMenu` module provides a customizable and interactive mega menu component
