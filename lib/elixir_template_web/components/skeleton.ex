defmodule ElixirTemplateWeb.Components.Skeleton do
  @moduledoc """
  The `ElixirTemplateWeb.Components.Skeleton` module provides a reusable component for displaying skeleton
