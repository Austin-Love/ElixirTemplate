defmodule ElixirTemplateWeb.Components.SpeedDial do
  @moduledoc """
  The `ElixirTemplateWeb.Components.SpeedDial` module provides a versatile speed dial component for Phoenix
