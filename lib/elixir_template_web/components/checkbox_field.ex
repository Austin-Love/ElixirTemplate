defmodule ElixirTemplateWeb.Components.CheckboxField do
  @moduledoc """
  ElixirTemplateWeb.Components.CheckboxField Module Provides a customizable checkbox component for use in Phoenix LiveView forms.
