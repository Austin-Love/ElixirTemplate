defmodule ElixirTemplateWeb.Components.Tabs do
  @moduledoc """
  `ElixirTemplateWeb.Components.Tabs` is a Phoenix component module that provides a highly customizable tab
  ...
  import ElixirTemplateWeb.Components.Badge, only: [badge: 1]
