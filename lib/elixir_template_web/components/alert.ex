defmodule ElixirTemplateWeb.Components.Alert do
  @moduledoc """
  ElixirTemplateWeb.Components.Alert module provides collection of alert components and helper functions for managing and displaying alerts
