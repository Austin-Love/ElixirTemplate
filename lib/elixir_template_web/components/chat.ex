defmodule ElixirTemplateWeb.Components.Chat do
  @moduledoc """
  `ElixirTemplateWeb.Components.Chat` is a Phoenix LiveView component module for creating customizable chat interfaces.
