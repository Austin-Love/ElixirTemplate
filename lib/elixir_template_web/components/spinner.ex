defmodule ElixirTemplateWeb.Components.Spinner do
  @moduledoc """
  The `ElixirTemplateWeb.Components.Spinner` module provides a dynamic and customizable loading spinner
  ...
  With its flexible design, the `ElixirTemplateWeb.Components.Spinner` module enables developers to provide
