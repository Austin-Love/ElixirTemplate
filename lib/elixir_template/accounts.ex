defmodule ElixirTemplate.Accounts do
  ...
  alias ElixirTemplate.Accounts.{User, UserToken, UserNotifier}
  ...
  See `ElixirTemplate.Accounts.User.email_changeset/3` for a list of supported options.
  ...
  See `ElixirTemplate.Accounts.User.password_changeset/3` for a list of supported options.
