defmodule ElixirTemplateWeb.ConnCase do
  ...
  def register_and_log_in_user(%{conn: conn} = context) do
    user = ElixirTemplate.AccountsFixtures.user_fixture()
    scope = ElixirTemplate.Accounts.Scope.for_user(user)
  ...
  def log_in_user(conn, user, opts \\ []) do
    token = ElixirTemplate.Accounts.generate_user_session_token(user)
  ...
  defp maybe_set_token_inserted_at(token, inserted_at) do
    ElixirTemplate.AccountsFixtures.override_token_inserted_at(token, inserted_at)
  end
end
